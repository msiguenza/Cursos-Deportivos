...
public class CrearAlumnos extends JDialog {
	...
	public CrearAlumnos() throws IOException, SQLException {
		...
		//LLAMADA  AL CONTROLADOR CREAR ALUMNO PARA QUE REALICE LA ACCIÓN
		...
		//LLAMADA AL CONTROLADOR SALIR PARA QUE EJECUTE LA ACCIÓN DE SALIDA
		...
		//METODO QUE DESHABILITA LA EDICIÓN MANUAL DE TABLAS DE FORMA VISUAL
	...
	// CONTROLADOR PREPARATABLACURSOS
